...
import { Vote, LayoutDashboard, Users, Megaphone, ScrollText, Trophy, Calendar, UserCircle, Settings, LogOut, ShieldCheck, ListChecks } from "lucide-react";
    ...
    <div className="flex min-h-screen w-full bg-background">
      ...
      <main className="flex-1 min-w-0">
        <header className="md:hidden flex items-center justify-between border-b px-4 py-3 bg-card">
          <Link to="/" className="font-display text-lg">StudentGov</Link>
          <button onClick={signOut} className="p-2"><LogOut className="size-5" /></button>
        </header>
