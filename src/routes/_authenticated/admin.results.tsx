        ...
        <div className="space-y-12">
          ...
          <div className="flex justify-between text-center pt-8 border-t border-black/20 text-sm">
            <div className="w-64 space-y-1">
              <div className="font-bold border-b border-black pb-1">Miller E. Labrador</div>
              <div className="text-xs text-black/60">COMEL Electoral Board Chair</div>
            </div>
            <div className="w-64 space-y-1">
              <div className="font-bold border-b border-black pb-1">Maryell M. Maglangit</div>
              <div className="text-xs text-black/60">Student Affairs Director</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="space-y-6 print:space-y-4 print:bg-white print:text-black">
      ...
      <div className="hidden print:block mt-16 pt-8 border-t-2 border-black text-center text-sm">
        ...
        <div className="mt-16 flex justify-around">
          <div className="w-48 border-t border-black pt-2">Miller E. Labrador<br/><span className="text-xs">COMEL Electoral Board Chair</span></div>
          <div className="w-48 border-t border-black pt-2">Maryell M. Maglangit<br/><span className="text-xs">Student Affairs Director</span></div>
        </div>
      </div>
    </div>
  );
